...
$query="select * from studentrequest where acedemic='$inchargeyear'";
...
echo"<table class='table'>";
   ...
   {
	if($row["facultystatus"]=="ACCEPTED" || $row["facultystatus"]=="REJECTED")
	{
		echo" <tr class='info'>";
	echo"    <td>",$row['id'],"</td>";
	...
	echo"    <td>",$row['reason'],"</td>";
     echo"   <td>",$row['hodstatus'],"</td>";
	 $a=$row["id"];
	 echo"    <td>",$row['facultystatus'],"<form method='post' action = 'acceptstudentrequest.php' class='form' id='ACCEPT'>
