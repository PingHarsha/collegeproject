...
$query="select * from hodrequest where fromuser='$user_id'";
...
echo"<table class='table'>";
   ...
   while($row=mysqli_fetch_array($result))
   {
	...
	echo"    <td>",$row['reason'],"</td>";
	 ...
	 echo"    <td><form method='post' action = 'deleterequest.php' class='form' value='DELETE'>
	 <input type = 'hidden' name = 'id' value=",$a,"/>
<input type = 'submit' name = 'delete'/></form></td>";
     echo" </tr>";
   }
    echo"</tbody>";
 echo" </table>";
